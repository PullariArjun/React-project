...
const AppComponent = () => {
  ...
  return (
    <Container>
      <Header>
        <AppName>
          <RecipeImage src="/react-recipe-finder/hamburger.avif" />
          Recipe Finder
        </AppName>
        <SearchBox>
          <SearchIcon src="/react-recipe-finder/searchicon.avif" />
          <SearchInput
      ...
      <RecipeListContainer>
        {recipeList?.length ? (
          ...
          <Placeholder src="/react-recipe-finder/hamburger.avif" />
        )}
      </RecipeListContainer>
    </Container>
  );
